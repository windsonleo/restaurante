...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i ><img src="${pageContext.request.contextPath}/resources/images/icons/16/compras.png" /></i> Pedidovenda</a> >> <a href="#" class="current">Movimentação de PedidoCompra</a> </div>
