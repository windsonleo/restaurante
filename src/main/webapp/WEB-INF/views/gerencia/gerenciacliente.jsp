...
<%@ page session="true" %>
 ...
 <div id="content">
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="${pageContext.request.contextPath}/cliente/movimentacao" title="Go to Cliente" class="tip-bottom"><i class="icon-home"></i> Cliente</a> <a href="#">Gerência Cliente </a> </div>
      ...
      <div class="span12">
			...
			<form action="LocalizarClienteGerencia" method="POST" class="form-horizontal">		
                ...
                <div class="controls">
								...
								<input type="text" list="${clientesList}" id="id" placeholder="Digite o Código do Cliente" name="id" autocomplete="off" class="form-horizontal">
...
<%-- 									<input type="text"  id="telefone" name="telefone"  class="" value="${cliente.telefone }" placeholder="Digite o Telefone"> --%>
     ...
     <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
            <h5>Dados do Cliente</h5>
                ...
                <div class="controls">
						<input id="id"  name="id" type="text" value="${cliente.id}" placeholder="Digite o Id" disabled="true"/>
               			<input id="isativo" class="span3"name="isativo"  type="checkbox" checked="${cliente.isativo}" disabled="true"/>
               
						<input type="image" alt="cliente foto" src="${pageContext.request.contextPath}/resources/images/cliente/${cliente.foto}.jpg" class="span2" disabled="true">				
