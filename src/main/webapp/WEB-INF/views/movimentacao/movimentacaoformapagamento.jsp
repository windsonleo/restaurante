...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"><a href="#" title="Go to Forma de Pagamento" class="tip-bottom"><i><img
                src="${pageContext.request.contextPath}/resources/images/icons/16/financeiro.png"></i> Forma de
            Pagamento</a> <a href="#" class="current">Movimentação de Forma de Pagamento</a></div>
                ...
                <div class="widget-box">
                    <div class="widget-title"><span class="icon"><i class="icon-icon"><img
                        ...
                        <div class="widget-title"><span class="icon"><a
                                href="${pageContext.request.contextPath}/formapagamento/cadastro"><i class="icon-plus"
                                                                                                     color="blue"></i></a> </span>
                                    ...
                                    <c:when test="${formapagamento.id != null}">
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td><fmt:formatNumber type="PERCENT"
                                                                  value="${formapagamento.percdesconto}"/></td>
                                            <td><span class="label label bg_lb">${formapagamento.isativo}</span></td>
                                            <td class="options-width">
                                                <a href="${pageContext.request.contextPath}/formapagamento/editar?id=${formapagamento.id}"
                                                   title="Editar"><i class="icon-edit"></i> </a>

                                                <a href="${pageContext.request.contextPath}/formapagamento/informacoes?id=${formapagamento.id}"
                                                   title="Informações"><i class="icon-info-sign"></i></a>

                                                <a href="#myAlert${formapagamento.id}" data-toggle="modal"
                                                ...
                                                <div id="myAlert${formapagamento.id}" class="modal hide">
                                                    ...
                                                    <div class="modal-footer"><a data-dismiss="" class="btn btn-danger"
                                                                                 href="${pageContext.request.contextPath}/formapagamento/delete?id=${formapagamento.id}">Confirma</a>
