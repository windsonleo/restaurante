...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"><a href="#" title="Go to Garcon" class="tip-bottom"><i><img
                src="${pageContext.request.contextPath}/resources/images/icons/16/garcon.png"></i> Garcon</a> <a
                href="#" class="current">Movimentação de Garcon</a></div>
            ...
            <div class="span12">
                ...
                <div class="widget-box">
                    <div class="widget-title"><span class="icon"><i><img
                            src="${pageContext.request.contextPath}/resources/images/icons/16/garcon.png"></i></span>
                        <h5>Movimentação Garcon</h5>

                        <div class="widget-title"><span class="icon"><a
                                href="${pageContext.request.contextPath}/garcon/cadastro"><i class="icon-plus"
                                                                                             color="blue"></i></a> </span>
                                    ...
                                    <c:when test="${garcon.id != null}">
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td class="options-widt">
                                                ...
                                                <a href="#myAlert${garcon.id}" data-toggle="modal" class="fa fa-remove"><i
                                                ...
                                                <div id="myAlert${garcon.id}" class="modal hide">
                                                    ...
                                                    <div class="modal-footer"><a data-dismiss="" class="btn btn-danger"
                                                                                 href="${pageContext.request.contextPath}/garcon/delete?id=${garcon.id}">Confirma</a>
