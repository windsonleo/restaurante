...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"><a href="#" title="Go to Home" class="tip-bottom"><i><img
                src="${pageContext.request.contextPath}/resources/images/icons/16/entregas.png"/></i> Pedidovenda</a> <a
                href="#" class="current">Movimentação de Pedidovenda</a></div>
            ...
            <div class="span12">
                ...
                <div class="widget-box">
                    <div class="widget-title"><span class="icon"><i><img
                            src="${pageContext.request.contextPath}/resources/images/icons/16/entregas.png"></i></span>
                        <h5>Movimentação Pedido Venda</h5>

                        <div class="widget-title"><span class="icon"><a
                                href="${pageContext.request.contextPath}/pedidovenda/cadastro"><i class="icon-plus"
                                                                                                  color="blue"></i></a> </span>
                        </div>
                    </div>
                                ...
                                <c:choose>
                                    ...
                                    <c:when test="${pedidovenda.id != null}">
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td>
                                                <fmt:formatDate value="${pedidovenda.data}"/>
                                            </td>
                                            ...
                                            <c:choose>
                                                ...
                                                <c:when test="${pedidovenda.status=='PENDENTE'}">
                                                    ...
                                                    <td><span class="label label-warning">${pedidovenda.status}</span>
                                                    </td>
                                                ...
                                                <c:when test="${pedidovenda.status=='PRONTO'}">
                                                    ...
                                                    <td><span class="label label-success">${pedidovenda.status}</span>
                                                    </td>
