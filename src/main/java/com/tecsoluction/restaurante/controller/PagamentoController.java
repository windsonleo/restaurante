...
public class PagamentoController extends AbstractController<Pagamento> {
	...
	private PagamentoServicoImpl pagamentoService;
	...
	@Autowired
	public PagamentoController(PagamentoServicoImpl dao, UsuarioServicoImpl daousu, CaixaServicoImpl CDAO,
			PedidoVendaServicoImpl peddao, FormaPagamentoServicoImpl formdao) {
		super("pagamento");
