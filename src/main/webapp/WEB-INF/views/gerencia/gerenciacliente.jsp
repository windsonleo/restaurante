...
<%--                                        <c:if test="${cliente != null }"> <img class="img" src="../resources/images/cliente/${cliente.foto}.jpg"></c:if> --%>
<%--                                         <c:if test="${cliente == null }"> <img class="img" src="../resources/images/cliente/vazio.jpg"></c:if> --%>
