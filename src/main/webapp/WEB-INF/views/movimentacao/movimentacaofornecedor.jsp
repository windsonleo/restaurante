...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"><a href="#" title="Go to Fornecedor" class="tip-bottom"><i><img
                src="${pageContext.request.contextPath}/resources/images/icons/16/fornecedor.png"></i> Fornecedor</a> <a
                href="#" class="current">Movimentação de Fornecedor</a></div>
            ...
            <div class="span12">
                ...
                <div class="widget-box">
                    <div class="widget-title"><span class="icon"><i class="icon-icon"><img
                            src="${pageContext.request.contextPath}/resources/images/icons/16/fornecedor.png"></i></span>
                        <h5>Movimentação Fornecedor</h5>

                        <div class="widget-title"><span class="icon"><a
                                href="${pageContext.request.contextPath}/fornecedor/cadastro"><i class="icon-plus"
                                                                                                 color="blue"></i></a> </span>
                                    ...
                                    <c:when test="${fornecedor.id != null}">
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td class="options-width">
                                                ...
                                                <a href="#myAlert${fornecedor.id}" data-toggle="modal"
                                                ...
                                                <div id="myAlert${fornecedor.id}" class="modal hide">
                                                    ...
                                                    <div class="modal-footer"><a data-dismiss="" class="btn btn-danger"
                                                                                 href="${pageContext.request.contextPath}/fornecedor/delete?id=${fornecedor.id}">Confirma</a>
