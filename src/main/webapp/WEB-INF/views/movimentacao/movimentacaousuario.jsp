...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Usuario" class="tip-bottom"><i ><img src="${pageContext.request.contextPath}/resources/images/icons/16/usuario.png" ></i> Usuario</a> <a href="#" class="current">Movimentação de Usuario</a> </div>
