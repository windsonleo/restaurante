...
//	}
    ...
    @Autowired
    public RecebimentoController(RecebimentoDAO daorec,PedidoCompraDAO dao, ItemDAO daoitem, ProdutoDAO produtodao, FornecedorDAO fdao,UsuarioDAO daousu) {
...
//		    	this.pagamento.setDatapagamento(new Date ());
		      ...
		      //  recebimento.setPedidocompra(pv);
		        ...
		        cadastrorecebimento.addObject("pedidocompra", pv);
		        cadastrorecebimento.addObject("acao","add");
		        cadastrorecebimento.addObject("recebimento",recebimento);
