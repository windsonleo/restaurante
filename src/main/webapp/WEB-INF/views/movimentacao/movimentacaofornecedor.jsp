...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Fornecedor" class="tip-bottom"><i ><img src="${pageContext.request.contextPath}/resources/images/icons/16/fornecedor.png" ></i> Fornecedor</a> <a href="#" class="current">Movimentação de Fornecedor</a> </div>
  ...
  <div class="container-fluid">
   ...
   <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-icon"><img src="${pageContext.request.contextPath}/resources/images/icons/16/fornecedor.png" ></i></span>
