...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/resources/js/cardapio/jquery-1.11.2.min.js"></script>

<script type="text/javascript"
        src="${pageContext.request.contextPath}/resources/js/cardapio/jquery.flexslider.min.js"></script>
...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/resources/js/cardapio/jquery.mixitup.min.js"></script>
...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/resources/js/cardapio/jquery.hoverdir.js"></script>
<script type="text/javascript"
        src="${pageContext.request.contextPath}/resources/js/cardapio/jQuery.scrollSpeed.js"></script>
