...
<!-- 														                <div class="user-thumb"> <img width="40" height="40" alt="User" src="resources/images/demo/av3.jpg"> </div> -->
                                                            ...
                                                            <button type="submit" rel="tooltip" title="preparando" class="btn btn-danger btn-simple btn-xs" onclick="window.location='${pageContext.request.contextPath}/pedidovenda/item/preparar?id=${pv.id}&key=${item.key.id}'">
