...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"><a href="#" title="Go to Estoque" class="tip-bottom"><i class="icon-home"></i> Estoque</a>
            <a href="#" class="current">Movimentação de Estoque</a></div>
                ...
                <div class="widget-box">
                    <div class="widget-title"><span class="icon"><i class="icon-th"></i></span>
                        ...
                        <div class="widget-title"><span class="icon"><a
                                href="${pageContext.request.contextPath}/estoque/cadastro"><i class="icon-plus"
                                                                                              color="blue"></i></a> </span>
                                    ...
                                    <c:when test="${estoque.id != null}">
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td class="options-width">
                                                ...
                                                <a href="#myAlert${estoque.id}" data-toggle="modal"
                                                ...
                                                <div id="myAlert${estoque.id}" class="modal hide">
                                                    ...
                                                    <div class="modal-footer"><a data-dismiss="" class="btn btn-danger"
                                                                                 href="${pageContext.request.contextPath}/estoque/delete?id=${estoque.id}">Confirma</a>
        ...
        <div class="row">
            <div class="col-sm-12">
                <h1 class="page-header">
                    Estoque
                    <small>Listagem e Visão Geral</small>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group input-group">
                            ...
                            <span class="input-group-btn"><button class="btn btn-sm btn-primary" type="button"><i
                                    class="fa fa-search"></i></button> <button type="button"
